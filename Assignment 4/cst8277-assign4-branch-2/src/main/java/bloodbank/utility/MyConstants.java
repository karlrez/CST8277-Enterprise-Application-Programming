...
public interface MyConstants {
    ...
    public static final String RECORD_RESOURCE_NAME =  "record";
    public static final String DONATION_RESOURCE_NAME =  "donation";
    ...
    public static final String PHONE_SUBRESOURCE_NAME =  "phone";
    public static final String CUSTOMER_PHONE_SUBRESOURCE_NAME =  "phone";
